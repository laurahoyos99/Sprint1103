...
SELECT MesC,Provincia, Canton,Distrito,ROUND(AVG(PrecioMbp),2) AS PrecioMbp, COUNT(DISTINCT CONTRATOCRM) AS Churners
...
AND PFLAG="3P"
GROUP BY 1,2,3,4
ORDER BY Mesc,Provincia,Canton,Distrito
