...
SELECT DISTINCT PD_BB_PROD_ID, PD_BB_PROD_NM, BB_FI_TOT_MRC_AMT AS MRC_SinDescuento,BB_FI_TOT_MRC_AMT-BB_FI_TOT_MRC_AMT_DESC AS MRC_ConDescuento
 , RangoVelocidad
